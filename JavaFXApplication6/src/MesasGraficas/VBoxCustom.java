 ...
 * @author pablo
 */
public class VBoxCustom extends VBox implements BoxCustom {
    ...
    public VBoxCustom(String num) {
        ...
        circle.setOnMouseEntered(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                //System.out.println("coor:x " + circle.getBoundsInParent().getMinX());
                //System.out.println("coor:Y " + circle.getBoundsInParent().getMaxY());
            }
        });
